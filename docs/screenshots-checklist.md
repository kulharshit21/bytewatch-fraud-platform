...
2. `docs/screenshots/02-cases-backlog.png`
   Caption: `Open review backlog updating from the real API with fresh rows highlighted.`
3. `docs/screenshots/03-case-detail.png`
...
- Prefer dark-theme captures that match the shipped analyst console.
...
- Optional animated GIF: overview live mode plus one real demo burst
- Optional short case-review clip: queue to detail to feedback
